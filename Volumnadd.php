        ...
        <form method="post" class="form-horizontal mt-5">
            <div class="container">
                <div class="form-group text-center">
                    <div class="row">
                        <label for="DealerName" class="col-sm-3 control-label">Volumn</label>
                        <div class="col-sm-7">
                            <input type="text" name="Volumn" class="form-control" placeholder="Enter Volumn...">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group text-center">
                    <div class="col-md-12 mt-3">
                        ...
                        <a href="Volumnshow.php" class="btn btn-danger">Back</a>
                    </div>
                </div>
            </div>
        </form>

<?php 
    ...
    if (isset($_REQUEST['btn_insert'])) {
        ...
        if (empty($DealerName)) {
            ...
            $sql = "INSERT INTO tbl_dealer(DealerName,DealerAddress,DealerPhone) VALUES ('$DealerName', '$DealerAddress', '$DealerPhone')";
...
<body>
    ...
    <center><strong><h2>เพิ่มข้อมูลตัวแทนจำหน่าย</h2></strong></center>

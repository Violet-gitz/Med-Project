<?php
    ...
    if (isset($_REQUEST['Report'])) 
    {
        ...
        WHERE tbl_recclaim.RecClaimdate LIKE '%{$date}%'";
								...
								<div class="col-lg-12 col-md-12 col-sm-12">
									<div class="table-responsive">
										<table class="table custom-table m-0">
											<!-- <thead> -->
												<tr>
													<th width = "30">รายการเคลม</th>
                                                    <th width = "100">วันที่เคลม</th>
                                                    <th width = "30">ล็อตที่</th>
													<th width = "80">ชื่อยา</th>
                                                    <th width = "80">วันผลิต</th>
													<th width = "100">วันหมดอายุ</th>
                                                    <th width = "80">ชื่อพนักงาน</th>
											...
											<tbody>
                                                <?php
                                                    ...
                                                    {      
                                                        ...
                                                        $sql = "SELECT* FROM tbl_recclaim WHERE ClaimId=$ClaimId";
                                                        $result = $conn->query($sql);
                                                        $data = array();
                                                        while($row = $result->fetch_assoc()) {
                                                        $data[] = $row;  
												...
												<tr>
													...
													<td><?php echo $reclaim["RecClaimdate"];?></td>
												</tr>
                                                <tr>
                                                    <?php
                                                        ...
                                                        foreach($data as $key => $reclaim){
                                                            ...
                                                            $sqli ="SELECT * FROM tbl_lot WHERE $RecClaimid = RecClaimid";
                                                ...
                                                <tr>
													...
													<td width = "100"><?php echo $lot["Mfd"];?></td>
                                                    <td width = "100"><?php echo $lot["Exd"];?></td>
                                                    <td colspan="2"></td>
...
<?php
    ...
    $mpdf->WriteHTML($html);
    $mpdf->Output("report/รายงานการรับเคลมประจำเดือน.pdf");
    ob_end_flush();
?>

                ...
                <div id="navbar1" class="collapse navbar-collapse" style='justify-content: end;'>
                    <div class="dropdown">
                        ...
                        <div id="navbar1" class="collapse navbar-collapse">
                            ...
                            <li class="nav-item">
                                    <td><a href="Typeadd.php" class ="btn btn-success" style ="width: 120px;">เพิ่มประเภท</a></td>
                                </li>
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><a href="Typeedit.php?update_id=<?php echo $type["TypeId"];?>" class="btn btn-warning">แก้ไขข้อมูล</a></td>
                        <form action = "Typeshow.php" method = "POST">
                            <input type ="hidden" name = "delete_id" value = "<?php echo $type["TypeId"]; ?>">
                            <td><button class ="btn btn-danger" type = "submit" name = "delete" onclick ="deleteFunction(`<?php echo $type['TypeId']; ?>`)">ลบ</button></td>
                        </form>
                    </tr>
